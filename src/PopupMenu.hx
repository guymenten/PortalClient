...
class PopupMenu extends Sprite
{
	...
	public function doPopupMenuTest():Void{
		...
		var iconItem:JMenuItem = new JMenuItem("Has Icon Long Long Long item", new ColorIcon(ASColor.ALIZARIN, 20, 20));
