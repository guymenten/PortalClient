 ...
 * @author lastdance
 */
class RPMLaf extends BasicLookAndFeel{
 
	var DEFFONT:String = "Arial";
	public static var scrollbarScale:Float = 2;
	...
	private override function initSystemColorDefaults(table:UIDefaults):Void{
		var defaultSystemColors:Array<Dynamic>= [
			...
			"menuText", 0xFFFFFE, /* Text color for menus  */
			"control", 0xFFFFFE, /* Default color for background in controls */
		...
		table.set("selectionBackground", new ASColorUIResource(ASColor.PETER_RIVER.getRGB()));
		table.set("selectionForeground", new ASColorUIResource(ASColor.CLOUDS.getRGB()));
	...
	private override function initComponentDefaults(table:UIDefaults):Void{
		...
		var textBG:ASColorUIResource = new ASColorUIResource(ASColor.PETER_RIVER.getRGB());  //new ASColorUIResource(0xfafafa );
		...
		var comDefaults:Array<Dynamic>= [
			...
			"Button.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()),
			"Button.mideground",   new ASColorUIResource(ASColor.PETER_RIVER.getRGB()), // table.get("controlMide"),
			...
			//"Button.bg",  new ASColorUIResource(ASColor.CLOUDS.getRGB()), // org.aswing.plaf.basic.background.ButtonBackground,
		...
		comDefaults = [
			...
			"LabelButton.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), 
		...
		comDefaults = [
			...
			"RadioButton.foreground",  new ASColorUIResource(ASColor.CLOUDS.getRGB()), 
		...
		comDefaults = [
			...
			"TextField.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), //table.get("controlText"), 
		...
		comDefaults = [
			...
			"CheckBox.foreground",  new ASColorUIResource(ASColor.CLOUDS.getRGB()),
		...
		comDefaults = [
			...
			"ScrollBar.barWidth", 	20,			//14, 
			"ScrollBar.minimumThumbLength", 32,		//24, 
		...
		// *** ScrollPane
		comDefaults = [
			"ScrollPane.background", null, //table.get("window"),
			"ScrollPane.foreground", table.get("windowText"), 
			"ScrollPane.mideground", null, //table.get("controlMide"), 
	   ...
	   // *** Label
		comDefaults = [
			"Label.background", textBG, //table.get("control"),
			"Label.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), 
			"Label.mideground", textBG, //table.get("controlMide"), 
	   ...
	   // *** TextArea
		comDefaults = [
			...
			"TextArea.foreground", new ASColorUIResource(ASColor.WET_ASPHALT.getRGB()), // table.get("controlText"), 
		...
		comDefaults = [
			...
			"List.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()),
			"List.mideground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), 
			"List.colorAdjust", new UIStyleTune(0.08, 0.05, 0.20, 0.20, 0), 
			"List.opaque", false, 
			"List.focusable", true, 
			"List.bg",  null,// org.aswing.plaf.basic.background.ListBackground, 
		    "List.selectionBackground", table.get("selectionBackground"),
		    "List.selectionForeground", new ASColorUIResource(ASColor.CLOUDS.getRGB()),
		];
		table.putDefaults(comDefaults);
		...
		comDefaults = [
			...
			"ComboBox.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), //table.get("controlText" ), 
			...
			//"ComboBox.bg", new ASColorUIResource(ASColor.CLOUDS.getRGB()),
		...
		comDefaults = [
			...
			"Adjuster.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), //table.get("controlText"), 
		...
		comDefaults = [
			...
			"Stepper.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), //table.get("controlText"), 
	   ...
	   // *** JTabbedPane
		comDefaults = [
			...
			"TabbedPane.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), //table.get("controlText"), 
	   ...
	   // *** JClosableTabbedPane
		...
		comDefaults = [
			...
			"Table.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), //table.get("controlText"), 
		...
		comDefaults = [
			...
			"TableHeader.background", new ASColorUIResource(ASColor.WET_ASPHALT.getRGB()), //new ASColorUIResource(0xdbdbdb),
			"TableHeader.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()), //table.get("controlText"), 
		...
		table.putDefaults(comDefaults);
		 ...
		 // *** ToolBar
		comDefaults = [
			"ToolBar.background",  new ASColorUIResource(ASColor.PETER_RIVER.getRGB()),
	    ...
	    comDefaults = [
		    ...
		    "CheckBoxMenuItem.foreground", new ASColorUIResource(ASColor.CLOUDS.getRGB()),
