 ...
 * @author lastdance
 */
class RPMLaf2 extends LookAndFeel {
	...
	private function initSystemFontDefaults(table:UIDefaults):Void{
		var defaultSystemFonts:Array<Dynamic>= [
			"systemFont", new ASFontUIResource("Lato-Regular", 14),
			"menuFont", new ASFontUIResource("Lato-Regular", 14),
            "topMenuFont", new ASFontUIResource("Lato-Bold", 16),
			"controlFont", new ASFontUIResource("Lato-Regular", 16, false),
			"windowFont", new ASFontUIResource("Lato-Regular", 14, true),
            "controlHeaderFont", new ASFontUIResource("Lato-Bold", 18)
		];
	...
	private function initComponentDefaults(table:UIDefaults):Void{
		...
		comDefaults = [
			...
			"TextField.foreground", table.get("wet-asphalt"),//GM
		...
		comDefaults = [
			...
			"CheckBox.foreground", table.get("clouds"), //GM
		...
		comDefaults = [
			...
			"ScrollBar.mideground", new ASColorUIResource(0x444444),
	   ...
	   // *** JClosableTabbedPane
		...
		comDefaults = [
			...
			"TableHeader.foreground", table.get("clouds"),  //GM
