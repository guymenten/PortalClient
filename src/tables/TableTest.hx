...
class TableTest extends Sprite{
...
//		table.setIntercellSpacing(new Dimension(0, 0));
		...
		table.setBorder(new EmptyBorder(new LineBorder(null, ASColor.ALIZARIN, 2), new Insets(5, 5, 5, 5)));
		table.setRowSelectionInterval(10, 13);
		table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		var scrollPane:JScrollPane = new JScrollPane(table); 
		
		frame.getContentPane().append(scrollPane, BorderLayout.);
