...
class JOptionPane extends JPanel {
	...
	public function getOkButton():JButton{
		if(okButton == null){
			...
			okButton.setPreferredHeight(Hbut);
			okButton.setPreferredWidth(Wbut);
		}
		return okButton;
	}
	...
	public function getCancelButton():JButton{
		if(cancelButton == null){
			...
			cancelButton.setPreferredHeight(Hbut);
			cancelButton.setPreferredWidth(Wbut);
		}
		return cancelButton;
	}
	...
	public function getYesButton():JButton{
		if(yesButton == null){
			...
			yesButton.setPreferredHeight(Hbut);
			yesButton.setPreferredWidth(Wbut);
		}
		return yesButton;
	}
	...
	public function getNoButton():JButton{
		if(noButton == null){
			...
			noButton.setPreferredHeight(Hbut);
			noButton.setPreferredWidth(Wbut);
		}
		return noButton;
	}	
	...
	public function getCloseButton():JButton{
		if(closeButton == null){
			...
			closeButton.setPreferredHeight(Hbut);
			closeButton.setPreferredWidth(Wbut);
		}
		return closeButton;
	}	
	...
	private function addCloseListener(button:JButton):Void{
		...
		button.addActionListener(function(?e:Event=null):Void{ tryToClose(); });
	}
	...
	{
		var f:JFrame = getFrame();
		Fading.fadeOut(f, 0).onComplete(onFadeOutCompleted]);
	}
	
	function onFadeOutCompleted() 
	{
		var f:JFrame = getFrame();
		f.tryToClose();
	}
